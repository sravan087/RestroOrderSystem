...
namespace RestroRouting.Service.Tests.Logic
{
    ...
    public class DesertAreaProcesserTest
    {
        ...
        [Test]
        public async Task Given_Desert_Item_Returns_Completed_Task()
        {
            // Arrange
            var boothId = new Guid("44304ebe-1bdb-4887-a31b-c1dab224a6f2");
            var orderId = new Guid("4cdd3778-d297-499a-b07b-3c14afcdfc0c");
            var menuItem = new MenuItemData(new Guid("b99ca376-2b74-4276-908c-d27243d63ee7"), 1, 2.5M, Domain.MenuItemType.Desert);

            // Act
            IMenuItemProcesser menuItemProcesser = new DesertAreaProcesser(_mockBoothService.Object, _mockUow.Object, _mockMediator.Object);
